...
function buildInvoicePrompt() {
  return [
    ...
    '- For every item, return rawOcrLine when visible and itemConfidence from 0 to 1.',
    '- If the name looks like OCR noise, broken characters, random letters, or meaningless symbols, keep the rawOcrLine but set itemConfidence below 0.5 and add a warning.',
    'Example:',
    'Invoice item lines:',
    '卡奇锅巴（香辣味）',
    'K.Q. Rice Chips',
